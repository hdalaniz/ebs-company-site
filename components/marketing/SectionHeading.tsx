  ...
  return (
    <div>
      ...
      <h2
        ...
        className={
          eyebrow
            ? "mt-4 max-w-xl text-2xl font-bold tracking-tight text-ink sm:text-3xl lg:text-[2.15rem]"
            : "max-w-xl text-2xl font-bold tracking-tight text-ink sm:text-3xl lg:text-[2.15rem]"
        }
      >
        {heading}
      </h2>
